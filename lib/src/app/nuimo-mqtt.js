...
class NuimoMQTT {
  ...
  subscribe() {
    const heartbeatObservable = (0, rxjs_1.interval)(4000).pipe(
      (0, rxjs_1.filter)((_) => !!this.nuimo.rssi && !!this.nuimo.batteryLevel),
      (0, rxjs_1.tap)((_) =>
        this.mqtt.publish(
      ...
      (0, rxjs_1.tap)((_) =>
        this.nuimo.displayGlyph(rocket_nuimo_1.emptyGlyph, { brightness: 1 })
      )
    );
