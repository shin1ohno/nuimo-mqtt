...
const ConfigStore = {
  loadConfigFile(fileName) {
    return (0, promises_1.access)(fileName, fs_1.constants.R_OK).then(() =>
      (0, promises_1.readFile)(fileName, { encoding: "utf8" })
    );
  },
  loadRoonConfig() {
  ...
  saveControllerConfig(config, nuimoId) {
    return this.loadConfigFile(CONTROLLERS_CONFIG)
      ...
      .then((configs) =>
        this.saveConfigFile(CONTROLLERS_CONFIG, "x", {
          controllerSettings: configs,
        })
      );
  },
};
